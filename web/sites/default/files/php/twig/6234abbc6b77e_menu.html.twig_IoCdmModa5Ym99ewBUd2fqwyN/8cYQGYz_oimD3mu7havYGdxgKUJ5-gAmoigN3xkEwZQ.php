...
/* themes/contrib/panache/templates/menu.html.twig */
class __TwigTemplate_62aab0043846a8590a5a9241665aa67547b0489064eb893ff3a6513eb488ad67 extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "<ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ("menu menu-level" . $this->sandbox->ensureToStringAllowed(($context["menu_level"] ?? null), 33, $this->source))], "method", false, false, true, 33), 33, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 35
                    echo "    <ul class=\"menu menu-level";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["menu_level"] ?? null), 35, $this->source), "html", null, true);
                    echo "\">
        ";
                }
                // line 37
...
$context["item"], "in_active_trail", [], "any", false, false, true, 43)) ? ("menu-item--active-trail") : (""))];
                ...
                ";
                    // line 48
                    if (twig_get_attribute($this->env, $this->source, $context["item"], "is_expanded", [], "any", false, false, true, 48)) {
                        // line 49
                        echo "                <span class=\"menu-accordion-icon\"><i class=\"fas fa-angle-down\"></i></span>
                ";
                    }
                    // line 51
                    echo "
    ...
    {
        return "themes/contrib/panache/templates/menu.html.twig";
    }
    ...
    {
        return array (  132 => 57,  125 => 55,  119 => 53,  117 => 52,  114 => 51,  110 => 49,  108 => 48,  104 => 47,  99 => 46,  97 => 43,  96 => 42,  95 => 41,  94 => 39,  92 => 38,  87 => 37,  81 => 35,  75 => 33,  72 => 32,  69 => 31,  66 => 30,  51 => 29,  44 => 27,  41 => 22,  39 => 21,);
    }
 ...
 *   - localized_options: Footer link localized options.
...
<ul{{ attributes.addClass('menu menu-level' ~  menu_level) }}>
    ...
    <ul class=\"menu menu-level{{ menu_level }}\">
        ...
        {% for item in items %}
            ...
            <li{{ item.attributes.addClass(classes) }}>
                ...
                {% if item.is_expanded %}
                <span class=\"menu-accordion-icon\"><i class=\"fas fa-angle-down\"></i></span>
                {% endif %}
    ...
    {% endif %}
{% endmacro %}
", "themes/contrib/panache/templates/menu.html.twig", "C:\\wamp64\\www\\recettes\\web\\themes\\contrib\\panache\\templates\\menu.html.twig");
    }
